...
/*
    ...
    1-1.  Let T is a general k-ary tree and T’ is a binary tree converted from T. 
...
void task_2(ofstream &fout, const char *tree_string,
    const char *traverse_mode, int node_value) {
  fout << "[Task 2]" << endl;
  try {
    BinaryTree tree;
...
/*
    ...
    Description:
        Check whether a given binary tree is a reverse complete binary tree or not.
        TODO:
    ...
    Output:
        - "True" if the given tree is reverse complete binary tree, "False" otherwise
*/
...
/*
    ...
    Input:
        ...
        (‘delMax’,NULL): delete highest priority letter from current binary max heap
...
int main(int argc, char **argv) {
  ...
  case 0:
    task_1(fout, "1");
    task_1(fout, "2");
    task_2(fout, TASK_2_DEFAULT_ARGUMENT, TASK_2_DEFAULT_ARGUMENT_2,TASK_2_DEFAULT_ARGUMENT_3);
